...
class ThemeCustomizer {
    ...
    setSwitchFromConfig() {
        sessionStorage.setItem("__OSEN_CONFIG__", JSON.stringify(this.config)), document.querySelectorAll(".right-bar input[type=checkbox]").forEach(function(e) {
            e.checked = !1
        });
...
(function(){
  ...
  let lastTheme = html.getAttribute('data-bs-theme');
