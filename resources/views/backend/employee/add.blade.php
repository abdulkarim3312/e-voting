...
<div class="card">
    <div class="card-header">
        <h3 class="card-title mb-0">কর্মকর্তা যোগ করুন</h3>
    </div>
    <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-4 mb-5">
                    <div class="">
                        ...
                        <input type="text" class="form-control" required name="name" value="{{ old('name') }}" placeholder="নাম">
                    </div>
                </div>
                <div class="col-md-4 mb-5">
                    <label for="">মোবাইল</label>
                    <input type="text" class="form-control" required name="phone" value="{{ old('phone') }}" placeholder="মোবাইল">
                </div>
                <div class="col-md-4 mb-5">
                    <label for="">ইমেইল</label>
                    <input type="text" class="form-control" required name="email" value="{{ old('email') }}" placeholder="ইমেইল">
                </div>
                <div class="col-md-4 mb-5">
                    <label for="">এনআইডি</label>
                    <input type="text" class="form-control" required name="nid" value="{{ old('nid') }}" placeholder="এনআইডি">
                </div>
                <div class="col-md-4 mb-5">
                ...
                <div class="col-md-6 mb-5">
                    <label for="">ছবি </label>
                    <input type="file" class="form-control" required name="photo" placeholder="ছবি">
                </div>
                <div class="col-md-6 mb-5">
                    <label for="">কর্মস্থল </label>
                    <input type="text" class="form-control" value="{{ old('working_place') }}" required name="working_place" placeholder="কর্মস্থল">
                </div>
            </div>
            <center>
