                    ...
                    <div class="row">
                        <div class="col-md-12 col-12 mb-5">
                            <div class="form-floating form-floating-outline">
                                <input type="text" class="form-control" id="floatingInput" placeholder="" aria-describedby="floatingInputHelp" name="zoneName" value="{{ $data->name }}" required>
                        ...
                        <div class="col-md-6 col-6 mb-5">
                            ...
                            <input type="hidden" name="districts" id="districts" value="{{ $data->districts }}">
...
// যদি #districts এ আগেই value থাকে, তা tags এ push কর
let existing = $('#districts').val();
if(existing){
    tags = existing.split(',');
}
...
$('#tagInput').on('input', function(){
    ...
    // suggestions থেকে remove করো already selected / #districts এ থাকা
    let currentTags = tags.slice(); // tags already selected
