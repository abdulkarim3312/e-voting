                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="avatar-md flex-shrink-0 me-2">
                                                    <span class="avatar-title bg-primary-subtle rounded-circle">
                                                        <img src="{{ asset('userend/images/products/logo/logo-1.svg') }}" alt="" height="22">
                                                    </span>
                                                </div>
                                                <div>
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="avatar-md flex-shrink-0 me-2">
                                                    <span class="avatar-title bg-info-subtle rounded-circle">
                                                        <img src="{{ asset('userend/images/products/logo/logo-4.svg') }}" alt="" height="22">
                                                    </span>
                                                </div>
                                                <div>
                                                    <span class="text-muted fs-12">Clothing</span> <br />
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="avatar-md flex-shrink-0 me-2">
                                                    <span class="avatar-title bg-secondary-subtle rounded-circle">
                                                        <img src="{{ asset('userend/images/products/logo/logo-5.svg') }}" alt="" height="22">
                                                    </span>
                                                </div>
                                                <div>
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="avatar-md flex-shrink-0 me-2">
                                                    <span class="avatar-title bg-danger-subtle rounded-circle">
                                                        <img src="{{ asset('userend/images/products/logo/logo-6.svg') }}" alt="" height="22">
                                                    </span>
                                                </div>
                                                <div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar-md flex-shrink-0 me-2">
                                                    <span class="avatar-title bg-primary-subtle rounded-circle">
                                                        <img src="{{ asset('userend/images/products/logo/logo-8.svg') }}" alt="" height="22">
                                                    </span>
                                                </div>
                                                <div>
                            ...
                            <table class="table table-custom align-middle table-nowrap table-hover mb-0">
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="avatar-lg">
                                                <img src="{{ asset('userend/images/products/p-1.png') }}" alt="Product-1" class="img-fluid rounded-2">
                                            </div>
                                        </td>
                                        <td class="ps-0">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="avatar-lg">
                                                <img src="{{ asset('userend/images/products/p-7.png') }}" alt="Product-1" class="img-fluid rounded-2">
                                            </div>
                                        </td>
                                        <td class="ps-0">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="avatar-lg">
                                                <img src="{{ asset('userend/images/products/p-4.png') }}" alt="Product-1" class="img-fluid rounded-2">
                                            </div>
                                        </td>
                                        <td class="ps-0">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="avatar-lg">
                                                <img src="{{ asset('userend/images/products/p-5.png') }}" alt="Product-1" class="img-fluid rounded-2">
                                            </div>
                                        </td>
                                        <td class="ps-0">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="avatar-lg">
                                                <img src="{{ asset('userend/images/products/p-6.png') }}" alt="Product-1" class="img-fluid rounded-2">
                                            </div>
                                        </td>
                                        <td class="ps-0">
